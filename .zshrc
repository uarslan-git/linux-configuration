...
alias sudo="sudo "
alias update="dconf-load $HOME/.config/dconf-settings && pushd ~/config; PACMAN='paru' PACMAN_AUTH='eval' makepkg -fsi; systemctl daemon-reload && systemctl --user daemon-reload && systemctl preset-all"
alias vi="nvim"
alias vim="nvim"
alias nc="--noconfirm"
